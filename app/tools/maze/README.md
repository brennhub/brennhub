...
- **길 도구 + "벽 생성"** — 길 도구로 통로만 칠하면(lime 마크 transient 오버레이), 그리드 **아래** "벽 생성" 버튼이 노출됨(0.7.1: 그리드 위 → 아래). 클릭 시: 마크 셀=EMPTY / start·goal=보존 / 그 외=WALL. 1 undo entry로 push, Ctrl+Z로 회복.
