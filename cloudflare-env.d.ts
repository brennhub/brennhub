/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 1f8545ea03121dcb184c37cdae91a4f5)
// Runtime types generated with workerd@1.20260508.1 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		DB: D1Database;
		SUPP_DB: D1Database;
		NAMING_DB: D1Database;
		AI: Ai;
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		AI_PROVIDER: "workers-ai";
		WORKER_SELF_REFERENCE: Fetcher /* brennhub-dev */;
	}
	interface Env {
		DB: D1Database;
		SUPP_DB: D1Database;
		...
		ASSETS: Fetcher;
		AI_PROVIDER: "workers-ai";
		WORKER_SELF_REFERENCE: Fetcher /* brennhub-dev */ | Service<typeof import("./.open-next/worker").default>;
	}
}
